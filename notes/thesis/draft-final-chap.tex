...
Defying the expectations shallow anaphora stimulus type has worse score than deep anaphora.
...
\item \utterance{b:}{To chápu, chtěla bys \textbf{ji} prostě nemít.}{I understand, you would just like to not have it.}
\item \textit{aborted}
\end{itemize}
\end{quote}
...
...
\item \utterance{b:}{Jakou máte \textbf{ji}, klasickou nebo něco speciálního?}{Which do you have her, classic or something special?}
...
even though the hardcoded response was meant to be nonassignable:
    ...
    \item \utterance{b:}{Tak to by mě zajímalo, jak na to \textbf{ona} potom zareagovala.}{Well I'd like to know how did she react to it afterwards.}
...
to the risk of another mapping candidate to have been mentioned in the meantime like in the following conversation:
    ...
    \item \utterance{b:}{Kterého hrdinu v \textbf{ní} hraješ nejraději?}{Which hero do you play most often in her? (dota 2 is feminine in Czech)}
...
In following conversation the stimulus references the \textit{african continent}
...
\item \utterance{b:}{Máš nějakou oblíbenou zemi nebo jazyk na \textbf{něm}?}{So you have a favorite country or language on him? (continent is masculine in Czech)}
...
\subsection{Associative anaphora}
    ...
    \item \utterance{b:}{Znamenalo to pro \textbf{něj} nějaké specifické komplikace?}{Did it for him entail some complications?}
    \item \utterance{h:}{No…je to priznak lymfomu}{Well... it is a symptom of lymphoma}
    \item ...
    \end{itemize}
    \end{quote}

    Here the last chatbot response contains an anaphora which
...
in terms of the sequential structure \footcite{schegloff1996turn} of the conversation:
    ...
    \item \utterance{b:}{Jak se rozsivky konkrétně podílejí na boji s \textbf{ní}?}{How diatoms specifically participate in the fight against it?}
...
\section{Topical (in)coherence}
    ...
    \item \utterance{b:}{Jak dlouho už \textbf{ji} studuješ?}{How long have you been studying it?}
    ...
    \item ...
     ...
     \item \utterance{b:}{Co jsi dělal, když tě začala \textbf{ona} bolet?}{What did you do when she started hurting? (note: head is feminine in Czech)}
...
\subsection{Hard shift refusal}
    ...
    \item \utterance{b:}{\textbf{Jeho} organické tvary a barvy mě fascinují. Jak se ti líbí ta?}{His organic shapes and color fascinate me. How to you like her?}
...
\subsection{Nontopicalized entities}
    ...
    \item \utterance{b:}{Jaké stavební projekty jsi v \textbf{něm} nejvíc dokončil?}{Which building projects did you finish the most in him (note: Minecraft is masculine in Czech)}
    \item \textit{aborted}
    \end{itemize}
    \end{quote}
...
\item \utterance{b:}{\textbf{Jakého} bys chtěl mít jako učitele?}{Which would you like to have as a teacher?}
...
This happened in the following case, for example, since
...
preventing a simple metacommunication.
    ...
    \item \utterance{b:}{\textbf{Které} konkrétně na \textbf{něj} mají vliv?}{Which exactly have influence on him?}
