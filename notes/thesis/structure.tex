...
In case of human–human communication, disruptions can however be cured easily \footcite{bublitz1999disturbed}\footcite{DINGEMANSE202430}.
...
topic shifts and nonassignable anaphore \footcite{bublitz1999disturbed}.
...
where a user poses a direct question or request without additional context or examples ().
...
A big issue with factuality is called hallucinating ().
...
They are also required to be ethically aligned with humans.
...
that will and do affect people on a daily basis.
...
keep track of which entities have been mentioned. () New or Old? Exploring How Pre–Trained Language Models Represent Discourse Entities
...
The approach here is opposite of automated annotation of anaphora in text () Annotating anaphoric phenomena in situated dialogue.
...
Compared to the shallow anaphore
...
has been called nonassignable anaphore.
