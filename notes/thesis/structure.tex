...
\begin{document}
   ...
   % annotate data
   % handle IAA
   % process annotated data with quantifiable data
   % remove emails from final data
   % handle zero anaphore data
   % conclude experiment
...
PILOT 10
	...
	further steps
        ...
        149 unmapped pseudoanaphore (mediace při rozvodu)
        ...
        127 repeating a question - topical incoherence
        259 epic remap
        ...
        relaxed style is reduced to repetition
...
\subsubsection{Making the chatbot aware of the general course of the conversation}
ending correctly
\subsubsection{Relating tracked entities to one another}
\subsubsection{Prompting unassignable anaphora}
