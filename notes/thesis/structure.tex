...
\section{Evaluation of shallow, deep, nonassignable categorization}
...
\subsubsection{Associativity in nonassignable anaphora}
\subsubsection{Prompting unassignable anaphora}
\subsubsection{More complex experiment design - reference}
\subsubsection{Types of deep and types of nonassignable}
\subsubsection{Topicalization}
\subsection{Zero reference to hypertopic}
