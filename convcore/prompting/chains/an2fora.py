...
def an2fora(args):
    ...
    messages = [
        SystemMessage(content="najdi ve větě jedno hlavní slovo, o kterém věta je a dej místo něj osobní nebo vztažné zájmeno. Určitě proveď záměnu, odstranit slovo nestačí. Ostatní tematická centra nech jak jsou."),
