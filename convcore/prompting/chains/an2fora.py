...
def anafora(args):
    ...
    messages = [
        SystemMessage(content="najdi ve větě jedno hlavní slovo, o kterém věta je a dej místo něj osobní nebo vztažné zájmeno. Ostatní tematická centra nech jak jsou."),
